...
`${GOPATH}/github.com/prateekjain87`
...
```
git remote set-url origin https://github.com/prateekjain87/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/prateekjain87
cd ${GOPATH}/github.com/prateekjain87
git clone https://github.com/prateekjain87/lsbeat
```
